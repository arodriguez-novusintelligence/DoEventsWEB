...
export const AIAssistantFAB: React.FC<AIAssistantFABProps> = ({ onClick }) => (
  <button
    ...
    className="de-ai-fab fixed bottom-24 right-4 z-30 flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-primary to-[hsl(var(--primary-deep,220_70%_45%))] text-primary-foreground shadow-lg"
  >
