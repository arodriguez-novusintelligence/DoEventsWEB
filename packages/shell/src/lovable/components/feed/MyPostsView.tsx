    ...
    <div className="mx-auto max-w-lg min-h-screen bg-secondary pb-24">
      ...
      <div className="px-4 pt-4 space-y-4">
        {loading ? (
          ...
          <div className="flex flex-col items-center gap-3 rounded-2xl border border-dashed border-primary/25 border-border/60 bg-card py-16 text-center shadow-sm ring-1 ring-primary/10">
            <div className="flex h-14 w-14 items-center justify-center rounded-full bg-primary/10 ring-2 ring-primary/20">
