...
const PrivateChatView = ({
  ...
  return (
    <div className="flex h-[100dvh] w-full min-w-0 flex-col overflow-hidden bg-secondary">
      {/* Top bar */}
      <div className="shrink-0 z-20 bg-card border-b border-border px-4 py-3">
        <div className="mx-auto flex max-w-lg items-center gap-3">
          <button onClick={onBack} className="flex items-center gap-1 text-sm font-semibold text-primary">
          ...
          <div className="min-w-0">
            ...
            <div className="flex items-center gap-1.5">
              <span className={cn('h-2 w-2 rounded-full', chat.user.isOnline ? 'bg-emerald-500' : 'bg-destructive')} />
