# Reporte empalme de gaps — Run 27904436890

| Campo | Valor |
|-------|-------|
| Generado | 2026-06-21 12:39 UTC |
| Batch | 1 / 6 |
| Gaps en batch | 20 |
...
|---------|-------|---------|-------|
| Similitud global | **80.86%** | **80.84%** | **-0.02%** |
| Gaps pendientes totales | 117 | 117 | +0 |
| Gaps mejorados en batch | — | **6** / 20 | — |

## Empalme realizado (este batch)

| Feature (Lovable) | WEB | Sim. antes | Sim. después | Mejoró |
|-------------------|-----|------------|--------------|--------|
| Seating map editor | `packages/shell/src/lovable/components/events/SeatingMapEditor.tsx` | 84.63% | 84.63% | ⚠️ |
| Step unified | `packages/shell/src/lovable/components/services/StepUnified.tsx` | 80.73% | 80.65% | ⚠️ |
| Host picker | `packages/shell/src/lovable/components/events/HostPickerModal.tsx` | 83.17% | 82.88% | ⚠️ |
| Main info section | `packages/shell/src/lovable/components/venues/sections/MainInfoSection.tsx` | 78.9% | 78.92% | ✅ |
| Add guest | `packages/shell/src/lovable/components/guests/AddGuestModal.tsx` | 79.51% | 79.45% | ⚠️ |
| Service detail | `packages/shell/src/lovable/components/services/ServiceDetailView.tsx` | 83.01% | 82.2% | ⚠️ |
| Faqsection | `packages/shell/src/lovable/components/venues/sections/FAQSection.tsx` | 83.99% | 83.72% | ⚠️ |
| Step access control | `packages/shell/src/lovable/components/events/StepAccessControl.tsx` | 82.0% | 82.42% | ✅ |
| Refund ticket flow | `packages/shell/src/lovable/components/tickets/RefundTicketFlow.tsx` | 83.75% | 83.84% | ✅ |
| Event preview | `packages/shell/src/lovable/components/events/EventPreviewModal.tsx` | 83.2% | 84.07% | ✅ |
| My purchases | `packages/shell/src/lovable/components/purchases/MyPurchasesView.tsx` | 78.94% | 77.88% | ⚠️ |
| Company context | `packages/shell/src/lovable/contexts/CompanyContext.tsx` | 80.77% | 80.45% | ⚠️ |
| Banking hub | `packages/shell/src/lovable/components/banking/BankingHub.tsx` | 79.99% | 79.38% | ⚠️ |
| Aiassistant fab | `packages/shell/src/lovable/components/ai/AIAssistantFAB.tsx` | 84.96% | 84.13% | ⚠️ |
| Events | `packages/shell/src/lovable/components/feed/EventsView.tsx` | 81.2% | 81.2% | ⚠️ |
| Ticket detail | `packages/shell/src/lovable/components/tickets/TicketDetailView.tsx` | 77.77% | 77.74% | ⚠️ |
| Banner promocional | `packages/shell/src/lovable/components/feed/FeedBanner.tsx` | 84.57% | 84.72% | ✅ |
| My posts | `packages/shell/src/lovable/components/feed/MyPostsView.tsx` | 79.0% | 79.3% | ✅ |
| Seat location | `packages/shell/src/lovable/components/tickets/SeatLocationModal.tsx` | 79.52% | 79.2% | ⚠️ |
| Contact import | `packages/shell/src/lovable/components/guests/ContactImportModal.tsx` | 77.89% | 76.63% | ⚠️ |
...
| My posts | Feed / Inicio | `src/components/feed/MyPostsView.tsx` | needs_adaptation | 79.3% |
...
| Seating map editor | Mapa y eventos | `src/components/events/SeatingMapEditor.tsx` | needs_adaptation | 84.63% |
| Host picker | Mapa y eventos | `src/components/events/HostPickerModal.tsx` | needs_adaptation | 82.88% |
| Events | Mapa y eventos | `src/components/feed/EventsView.tsx` | needs_adaptation | 81.2% |
...
| Step access control | Crear / publicar evento | `src/components/events/StepAccessControl.tsx` | needs_adaptation | 82.42% |
...
| Event preview | Detalle de evento | `src/components/events/EventPreviewModal.tsx` | needs_adaptation | 84.07% |
...
| Banking hub | Pagos y banca | `src/components/banking/BankingHub.tsx` | needs_adaptation | 79.38% |
...
| Service detail | Servicios | `src/components/services/ServiceDetailView.tsx` | needs_adaptation | 82.2% |
| Step unified | Servicios | `src/components/services/StepUnified.tsx` | needs_adaptation | 80.65% |
