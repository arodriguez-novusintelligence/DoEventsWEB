# Actualiza CORS del bucket de imagenes de perfil para subidas desde QA web
param(
    [string]$Bucket = "doeventprofileimagesbucket",
    [string[]]$Origins = @(
...
$corsPath = Join-Path $PSScriptRoot "tmp-profile-bucket-cors.json"
